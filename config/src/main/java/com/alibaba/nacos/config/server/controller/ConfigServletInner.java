            ...
            try {
                ...
                if (PropertyUtil.isDirectRead()) {
                    ...
                    if (isV2) {
                        ...
                        resultMap.put("encryptedDataKey", configInfoBase.getEncryptedDataKey());
                        resultMap.put("content", configInfoBase.getContent());
                        resultMap.put("decodeContent", pair.getSecond());
                        resultMap.put("decodeContent_first", pair.getFirst());
                        Result<Map<String, String>> result = Result.success(resultMap);

//                        out.print(JacksonUtils.toJson(Result.success(pair.getSecond())));
                        out.print(JacksonUtils.toJson(result));
                    } else {
